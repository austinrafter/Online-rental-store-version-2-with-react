  ...
  render(){
    ...
    <div className = "checkout-form">
              ...
              <Form.Group as={Col} controlId="formGridName" required>
                ...
                <Form.Control type="text" name='name' placeholder="Your name" value={this.state.name} onChange={this.onChange} required/>
              </Form.Group>

                <Form.Group as={Col} controlId="formGridEmail" required>
                  <Form.Label>Email</Form.Label>
                  <Form.Control type="email" name='email' placeholder="Enter email" value={this.state.email} onChange={this.onChange} required/>
                </Form.Group>
                  </Form.Row>
              ...
              <Form.Row>
                <Form.Group as={Col} controlId="formGridCity" required>
                  ...
                  <Form.Control  name='city' placeholder="San Jose"  value={this.state.city} onChange={this.onChange} required/>
                </Form.Group>

                <Form.Group as={Col} controlId="formGridState" required>
                  <Form.Label>State</Form.Label>
                  <Form.Control as="select" name='unitedstate' value={this.state.unitedstate} onChange={this.onChange} required>
                ...
                <Form.Group as={Col} controlId="formGridZip" required>
                  ...
                  <Form.Control name='zipcode' placeholder='95117'value={this.state.zipcode} onChange={this.onChange} required/>
                </Form.Group>
              </Form.Row>
